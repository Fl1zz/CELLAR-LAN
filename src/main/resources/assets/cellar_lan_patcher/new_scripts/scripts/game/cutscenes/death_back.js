const sounds = [
    "mp.sounds:cellar_sounds.chapter1.cutscenes.death_back",
    "mp.sounds:cellar_sounds.chapter1.ost.rightnow_stop",
    "mp.sounds:cellar_sounds.chapter1.voice.death_back"
]
...
function main(c) {
    ...
    c.scheduleScript(185, function () {
        var players = c.getServer().getAllPlayers()
        for(var p in players) {
            var all_players = players[p]
            all_players.closeHUD("blackOut_death_back")
